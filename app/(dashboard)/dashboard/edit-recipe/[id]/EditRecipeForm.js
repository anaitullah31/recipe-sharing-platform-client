...
const EditRecipeForm = ({ recipe }) => {
  ...
  const [preview, setPreview] = useState(recipe?.recipeImage || "");
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-8">
          <p className="text-xs text-surface-secondary-foreground">
            ...
            <span className="text-accent">Edit Recipe</span>
          </p>

          <h1 className="mt-2 font-serif text-4xl md:text-5xl">Edit Recipe</h1>
        </div>
