    ...
    <section className="min-h-screen bg-background px-6 py-12 text-foreground lg:px-16">
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 flex flex-col justify-between gap-6 md:flex-row md:items-end">
          ...
          <button className="inline-flex w-fit items-center gap-2 rounded bg-accent px-6 py-3 text-xs font-bold uppercase text-accent-foreground hover:bg-accent-hover">
