    ...
    <section className="min-h-screen bg-background px-6 py-16 text-foreground lg:px-16">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="overflow-hidden rounded-lg border border-border bg-surface shadow-sm">
          <div className="hidden grid-cols-[1.5fr_1.2fr_0.8fr_0.8fr_1fr] border-b border-separator bg-surface-secondary px-7 py-6 text-sm font-bold md:grid">
          ...
          <div>
            {reports.map((report) => (
              <div
                key={report._id}
                className="grid gap-5 border-b border-separator px-7 py-6 last:border-b-0 md:grid-cols-[1.5fr_1.2fr_0.8fr_0.8fr_1fr] md:items-center"
              >
                ...
                <div className="flex items-center gap-3 md:justify-end">
                  ...
                  <button className="cursor-pointer bg-danger px-4 py-2 text-xs font-bold text-danger-foreground transition hover:opacity-90">
                    Remove Recipe
                  </button>
                </div>
              </div>
